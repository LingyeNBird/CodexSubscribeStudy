<!-- Source: https://raw.githubusercontent.com/can1357/oh-my-pi/main/assets/icon.svg; see LICENSES.txt. -->
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 90" aria-hidden="true" focusable="false">
